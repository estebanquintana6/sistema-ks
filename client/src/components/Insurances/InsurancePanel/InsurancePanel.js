...
class InsurancePanel extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      clients: [],
      companies: [],
      excludedFields: ['__v', '_id', 'active_status', 'endorsements', 'comments', 'status', 'created_at', 'tolerance', 'state', 'city', 'postal_code', 'gender', 'contacts', 'begin_date', 'invoices', 'cancelation_note']
    };
  }
